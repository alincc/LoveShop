...
var ViewCardStatementPageModule = (function () {
    function ViewCardStatementPageModule() {
    }
    ViewCardStatementPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__viewCardStatement__["a" /* ViewCardStatementPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__viewCardStatement__["a" /* ViewCardStatementPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__viewCardStatement__["a" /* ViewCardStatementPage */]
            ]
        })
    ], ViewCardStatementPageModule);
    return ViewCardStatementPageModule;
}());

//# sourceMappingURL=viewCardStatement.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewCardStatementPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
var ViewCardStatementPage = (function () {
    function ViewCardStatementPage(routerManager, navParams, navCtrl, viewCardStatementService) {
    ...
    ViewCardStatementPage.prototype.ionViewWillEnter = function () {
        ...
        if (this.routerManager.ifNotLoggedInThenGoBackToLoginScreen() === false) {
            ...
            if (this.navParams.get('data')) {
                ...
                var dataCooked = this.convertTransactionList(data.transactions);
                this.transaction.transactions = dataCooked;
                this.transaction.availableBalance = data.availableBalance;
            }
        }
    };
    ViewCardStatementPage.prototype.convertDate = function (date) {
        var a = date.split(/[^0-9]/);
        var jsDate = new Date(a[0], a[1] - 1, a[2], a[3], a[4], a[5]);
        if (this.isToday(jsDate)) {
            return 'today ' + __WEBPACK_IMPORTED_MODULE_5_date_fns_format___default()(jsDate, 'Do MMM YYYY');
        }
        else if (this.isYesterday(jsDate)) {
            return 'yesterday ' + __WEBPACK_IMPORTED_MODULE_5_date_fns_format___default()(jsDate, 'Do MMM YYYY');
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_5_date_fns_format___default()(jsDate, 'dddd Do MMM YYYY');
        }
    };
    ;
    ViewCardStatementPage.prototype.isYesterday = function (date) {
        var today = new Date();
    ...
    ViewCardStatementPage.prototype.isToday = function (date) {
        var today = (new Date());
        return (date &&
    ...
    ViewCardStatementPage.prototype.convertHour = function (date) {
        var a = date.split(/[^0-9]/);
        var hourAfterConvert = __WEBPACK_IMPORTED_MODULE_5_date_fns_format___default()(new Date(a[0], a[1] - 1, a[2], a[3], a[4], a[5]), 'HH:mm');
        return hourAfterConvert;
    };
    ;
    ViewCardStatementPage.prototype.statusOfAmount = function (amount) {
        var statusOfAmount = false;
        if (amount >= 0) {
            statusOfAmount = true;
        }
    ...
    ;
    ViewCardStatementPage.prototype.convertTransactionList = function (listTransaction) {
        var arr = [];
        var arrFinish = [];
        for (var _i = 0, listTransaction_1 = listTransaction; _i < listTransaction_1.length; _i++) {
            var transaction = listTransaction_1[_i];
            var dateAfterConvert = this.convertDate(transaction.date);
            var hourAfterConvert = this.convertHour(transaction.date);
            var statusOfAmount = this.statusOfAmount(transaction.amount);
            var transactionAfterConvert = {
        ...
        arr = arr.reverse();
        var arrayTransaction = __WEBPACK_IMPORTED_MODULE_6_lodash_groupby___default()(arr, function (item) {
            return item.dateAfterConvert;
        });
        var keys = Object.keys(arrayTransaction).sort(function (key1, key2) {
            var tran1 = arrayTransaction[key1];
            var tran2 = arrayTransaction[key2];
            var date1 = new Date(tran1[0].date);
            var date2 = new Date(tran2[0].date);
            if (date1 > date2) {
                return -1;
            }
            if (date1 < date2) {
    ...
    ViewCardStatementPage.prototype.getListCardStatement = function (cardData) {
        var _this = this;
        ...
        this.viewCardStatementService.getStatementList(cardData)
            ...
            var dataCooked = _this.convertTransactionList(body.transactions);
            _this.transaction.transactions = dataCooked;
            _this.transaction.availableBalance = body.availableBalance;
        }, function (error) {
            __WEBPACK_IMPORTED_MODULE_3__framework_services_loadingIndicatorService_loadingIndicator_service__["a" /* LoadingIndicatorService */].getInstance().hideLoadingIndicator();
        }, function () {
            __WEBPACK_IMPORTED_MODULE_3__framework_services_loadingIndicatorService_loadingIndicator_service__["a" /* LoadingIndicatorService */].getInstance().hideLoadingIndicator();
    ...
    ViewCardStatementPage.prototype._showError = function (message) {
    ...
    ViewCardStatementPage.prototype._handleError = function (res) {
        __WEBPACK_IMPORTED_MODULE_3__framework_services_loadingIndicatorService_loadingIndicator_service__["a" /* LoadingIndicatorService */].getInstance().hideLoadingIndicator();
    ...
    ViewCardStatementPage.prototype.getContentHardCode = function () {
        var _this = this;
        var observer = {
            next: function (res) {
                if (!res.ok) {
                ...
                var body = res.response;
                _this.make_first_transaction_with_card_MSG = body.message;
            },
    ...
    return ViewCardStatementPage;
}());

//# sourceMappingURL=viewCardStatement.js.map
