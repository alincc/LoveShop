...
var ChangeTouchIDPage = (function () {
    ...
    ChangeTouchIDPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-changeTouchID',template:/*ion-inline-start:"D:\L2S-New2310\src\spa\+screens\AccountManagement\changeTouchID\changeTouchID.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Touch ID\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-row padding>\n    <p>{{use_fingerprint_not_PIN}}</p>\n    <p>\n      <span>\n        {{use_same_finger}}\n      </span>\n    </p>\n  </ion-row>\n  <ion-row class="touch-setting">\n    <ion-item>\n      <ion-label>Touch ID</ion-label>\n      <ion-toggle class="new-style" [(ngModel)]="touchIDState" (ionChange)="changeTouchState()"></ion-toggle>\n    </ion-item>\n\n  </ion-row>\n</ion-content>\n\n\n          \n<ion-row style="display: none;" \n(click)="navCtrl.pop()"\nid="ChangeTouchIDPage-back-button">\n</ion-row>'/*ion-inline-end:"D:\L2S-New2310\src\spa\+screens\AccountManagement\changeTouchID\changeTouchID.html"*/
        }),
