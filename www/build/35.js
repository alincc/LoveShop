...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Exchange4ECodePageModule", function() { return Exchange4ECodePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exchange4ECode__ = __webpack_require__(912);
...
var Exchange4ECodePageModule = (function () {
    function Exchange4ECodePageModule() {
    }
    Exchange4ECodePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__exchange4ECode__["a" /* Exchange4ECodePage */]],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__exchange4ECode__["a" /* Exchange4ECodePage */])],
            exports: [__WEBPACK_IMPORTED_MODULE_2__exchange4ECode__["a" /* Exchange4ECodePage */]]
        })
    ], Exchange4ECodePageModule);
    return Exchange4ECodePageModule;
}());

//# sourceMappingURL=exchange4ECode.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Exchange4ECodePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__exchange4ECode_service__ = __webpack_require__(913);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__models_card_type__ = __webpack_require__(812);
...
;
var Exchange4ECodePage = (function () {
    function Exchange4ECodePage(routeManager, alertCtrl, navParams, navCtrl, exchange4ECodeService) {
        this.routeManager = routeManager;
        this.alertCtrl = alertCtrl;
        this.navParams = navParams;
        this.navCtrl = navCtrl;
        this.exchange4ECodeService = exchange4ECodeService;
        this.categoryName = 'Exchange for e-codes';
    ...
    Exchange4ECodePage.prototype.ionViewWillEnter = function () {
        this._resetData();
        if (this.routeManager.ifNotLoggedInThenGoBackToLoginScreen() === false) {
            __WEBPACK_IMPORTED_MODULE_7_jquery___default()('.app-root').removeClass('not-show-tab');
    ...
    Exchange4ECodePage.prototype.ionViewDidEnter = function () {
        this.calculateProductOnbasket();
    };
    Exchange4ECodePage.prototype.get4LastDigitsCardNumber = function (card) {
        var cardNumber = null;
        if (card.cardType === __WEBPACK_IMPORTED_MODULE_9__models_card_type__["a" /* CardType */].FLEXECODE) {
        ...
        if (card.cardType === __WEBPACK_IMPORTED_MODULE_9__models_card_type__["a" /* CardType */].FLEXECODE && cardNumber.indexOf('-') > 0) {
            cardNumber = cardNumber.replace(/-/g, "");
        }
        return cardNumber.substr(cardNumber.length - 4);
    };
    Exchange4ECodePage.prototype.calculateProductOnbasket = function () {
        this.productsOnBasket = 0;
    ...
    Exchange4ECodePage.prototype.ionViewDidLeave = function () {
        this._unsubscribe();
    };
    Exchange4ECodePage.prototype.gotoAllBarOneCode = function (product) {
        this.navCtrl.push('ExchangeEcodeAllBarOneEcodePage', { ecode: product, primaryCard: this.card, catalogue: this.catalogue });
    };
    Exchange4ECodePage.prototype.gotoTopUp = function () {
    ...
    Exchange4ECodePage.prototype._resetData = function () {
        this.products = [];
        this.benefit = null;
        this.catalogue = null;
        this.noContent = false;
    ...
    Exchange4ECodePage.prototype._buildCatalogueRequest = function () {
        var catalogueType = __WEBPACK_IMPORTED_MODULE_3__exchange4ECode_service__["a" /* CatalogueTypes */].PRODUCT;
        var body = {
    ...
    Exchange4ECodePage.prototype._extractsCardFromCatalogues = function (catalogues) {
        var products = [];
    ...
    Exchange4ECodePage.prototype._selectCategoryImage = function (cat) {
        if (cat.smallImages && Array.isArray(cat.smallImages) && cat.smallImages[0]) {
            return cat.smallImages[0];
        }
        return null;
    };
    Exchange4ECodePage.prototype._handleError = function (res) {
    ...
    Exchange4ECodePage.prototype._showError = function (message) {
    ...
    return Exchange4ECodePage;
}());

//# sourceMappingURL=exchange4ECode.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Exchange4ECodeService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
...
var Exchange4ECodeService = (function () {
    function Exchange4ECodeService(http) {
        this.http = http;
    }
    Exchange4ECodeService.prototype.getRetrieveCatalogue = function (body) {
        return this.http.post("card/catalogue", body);
    };
    Exchange4ECodeService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__framework_services_httpService_http_service__["a" /* HttpService */]])
    ], Exchange4ECodeService);
    return Exchange4ECodeService;
}());

//# sourceMappingURL=exchange4ECode.service.js.map
